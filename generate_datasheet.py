...
REGBANK_PATH = 'regbank.docx'
STYLE_PATH = 'style.docx'
OUTPUT_PATH = 'datasheet.docx'
...
def generate_datasheet(regbank_path, style_path, output_path):
    doc_style = docx.Document(style_path)
    doc_regbank = docx.Document(regbank_path)
    ...
    doc_style.save(output_path)


if __name__ == '__main__':
    generate_datasheet(REGBANK_PATH, STYLE_PATH, OUTPUT_PATH)
